...
<html lang="en">
  <head>
    ...
    <title>Binary Search Flowchart</title>
  ...
  <body>
    <div class="sidebar">
      ...
      <ul class="menu">
        ...
        <li class="menu-item" onclick="location.href='../Algorithms/binary_search.php'">
          📜Algorithm
        </li>
        <li
          class="menu-item"
    ...
    <div class="content-section">
      <div class="container">
        ...
        <img src="../../Images/Binary Search.png" alt="Flowchart" />
      </div>
    </div>
  </body>
</html>
