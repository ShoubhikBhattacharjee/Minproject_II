  ...
  <body>
    <div class="sidebar">
      ...
      <ul class="menu">
        ...
        <li class="menu-item" onclick="location.href='../basics_of_var.php'">
          🖥️Simulation
        </li>
        <li
          class="menu-item"
    ...
    <div class="container">
      ...
      <code>
        #include &lt;stdio.h&gt; int main() { int age; // Declaration age = 25;
        // Initialization printf("Age: %d\n", age); return 0; }
      </code>
      ...
      <code>
        #include &lt;stdio.h&gt; int main() { int a = 10; // Integer variable
        float pi = 3.14; // Floating point variable char grade = 'A'; //
        Character variable printf("a = %d, pi = %f, grade = %c\n", a, pi,
        grade); return 0; }
      </code>
      ...
      <code>
        #include &lt;stdio.h&gt; int main() { int x = 10, y = 5; printf("Sum:
      ...
      <code>
        ...
        temp; printf("After Swap: a = %d, b = %d\n", a, b); return 0; }
      </code>

      <h3>5. Real-World Example: Celsius to Fahrenheit Conversion</h3>
      <code>
        #include &lt;stdio.h&gt; int main() { float celsius, fahrenheit;
        printf("Enter temperature in Celsius: "); scanf("%f", &celsius);
        fahrenheit = (celsius * 9/5) + 32; printf("Temperature in Fahrenheit:
        %.2f\n", fahrenheit); return 0; }
      </code>
